...
Pet проект. Создавался с целью, на практике
...
Можно запустить локально или в докере. Doker Compose написан для комбинации модулей
"restModule" "dataModuleLimited" (Кейс 2 показался мне наиболее интересным)
